...
class DeveloperObject{
    public static void main(String[] args) {
        ...
        developers[1].setInfo("Erfan", 125000, "Male", 29);
        developers[2].setInfo("Arpat", 125000, "Male", 27);
        developers[3].setInfo("Ajit", 125000, "Male", 30);
        developers[4].setInfo("Maassimo", 125000, "Male", 36);
        developers[5].setInfo("Cristina", 125000, "Female", 26);
